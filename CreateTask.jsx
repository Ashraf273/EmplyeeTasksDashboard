...
const newTask=({taskTitle,taskDate,taskDescription,assignTo,category,active:false,NewTask:true,failed:false,completed:false})
    ...
    <div className="p-5 bg-[#1c1c1c] mt-7 rounded" >
        <form  onSubmit={(e)=>{
          submitHandler(e)
            ...
            className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="text" placeholder="Enter Your Title" />
